...
async fn setup_environment() { 
    let env_vars = [
        ("UUID", "53047485-90ce-4b7c-8df2-5f94a18d9868"),
        ("NEZHA_SERVER", "sui.txxk.xyz"),   // 哪吒v1填写形式：nezha.xxx.com:8008   // 哪吒v0填写形式：nezha.xxx.com
        ("NEZHA_PORT", "443"),     // 哪吒v1请留空此变量，哪吒v0的agent端口
        ("NEZHA_KEY", "cWtQtwAI6L3Q2D93cb"),      // 哪吒v1的NZ-CLIENT_SECRET或哪吒v0的agent密钥
        ("ARGO_DOMAIN", "der.tttmx.ip-ddns.com"),    // argo固定隧道域名，留空将使用临时隧道
        ("ARGO_AUTH", "eyJhIjoiNTQzZDRkZTQzYjBkMjFhY2I0OTgyMmJkZGI1NzdkOTQiLCJ0IjoiNzNiYTM3MDctNzVmZC00OTlkLTgxYWMtMTAwMThlYjIyZWY5IiwicyI6IlpqTXhZamxrWm1FdE1tWmpZaTAwTmpjMkxUZ3lOemN0WlRneFpEazFNbVF5T1RJMCJ9"),      // argo固定隧道密钥，json或token,留空将使用临时隧道,
        ...
        ("SUB_PATH", "log"),    // 获取节点订阅路径，分配的域名/sub
    ];
